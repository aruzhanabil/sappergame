...
file = 'desktop/Sapper_game/furelise.mp3'
pygame.init()
pygame.mixer.init()
...
boom = pygame.mixer.Sound('desktop/Sapper_game/Boom.mp3')
BLUE = (0, 0, 255)
...
class Menu():
    ...
    def draw(self, obj):
        ...
        if obj.game_lost:
            ...
            self.label_game_end.show(screen, "Oh no, Mine!")

        elif obj.game_won:
            self.label_game_end.show(screen, "Congratulations!")
